...
export type CreateTagAndAddToAnnotationMutation = (
  { __typename: 'Mutation' }
  & { createTag?: Maybe<{ tag?: Maybe<Pick<Tag, 'id' | 'tagId' | 'tagName'>>, query?: Maybe<{ annotationByAnnotationId?: Maybe<AnnotationAllFragment> }> }> }
);
...
export type DeleteAnnotationTagMutation = (
  { __typename: 'Mutation' }
  & { deleteAnnotationTagByAnnotationIdAndTagId?: Maybe<{ tagByTagId?: Maybe<(
      Pick<Tag, 'tagId' | 'tagName' | 'id'>
      & { annotationTagsByTagId: Pick<AnnotationTagsConnection, 'totalCount'> }
    )>, annotationByAnnotationId?: Maybe<AnnotationAllFragment> }> }
);
...
export type DeleteTagMutation = (
  { __typename: 'Mutation' }
  & { deleteTagByTagId?: Maybe<Pick<DeleteTagPayload, 'deletedTagId'>> }
);
...
export type GetPublicationByPublicationIdQuery = { publicationByPublicationId?: Maybe<(
    { bookByPublicationId?: Maybe<Pick<Book, 'bookTitle' | 'bookType' | 'description' | 'imageUrl' | 'languageCode' | 'isbn13' | 'publicationDate' | 'publicationId' | 'publisher'>> }
...
export type AnnotationAllFragment = (
  ...
  & { tagsByAnnotationTagAnnotationIdAndTagId: { nodes: Array<Maybe<Pick<Tag, 'id' | 'tagId' | 'tagName'>>> } }
);
