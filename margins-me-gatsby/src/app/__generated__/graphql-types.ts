...
export type DeleteAuthorByAuthorIdMutation = (
  { __typename: 'Mutation' }
  & { deleteAuthorByAuthorId?: Maybe<{ author?: Maybe<DeletedAuthorAndUpdatedPublicationsFragment> }> }
);
